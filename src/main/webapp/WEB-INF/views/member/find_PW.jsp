            ...
            <div class="toptitle">
                ...
                <div class="find_mem_wrap">
                    <div class="find_mem_inner">
                        ...
                        <strong class="find_mem_ttl">비밀번호 찾기</strong>
                        ...
                        <div class="find_mem_form">
                            <div class="find_mem_result">
                                ...
                                <p class="mem_result_txt">
                                    ...
                                    <span class="result_txt_sub">아래 인증 방법을 통해 비밀번호를 확인 하실 수 있습니다.</span>
                                </p>
                            </div>
                                ...
                                <div class="mem_cert_wrap_v2">
                                    <ul class="pro1">
                                        <li class="li1">
                                            ...
                                            <p class="p2">본인 명의의 휴대폰으로 본인 인증을 통해, 비밀번호를 확인하실 수 있습니다.</p>
                                        ...
                                        <li>
                                            ...
                                            <p class="p2">아이핀 본인 인증을 통해, 비밀번호를 확인하실 수 있습니다.</p>
