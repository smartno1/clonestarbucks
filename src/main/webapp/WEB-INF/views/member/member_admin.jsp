                ...
                <div class="toptittle"><%-- 머리글 --%>
                    ...
                    <div class="body-box"><%--body-box--%>
                        <nav class="ms_nav" id="msRnb">
                            <ul>
                                <li class="msRnb_btn"><a href="/member/member_admin">회원관리</a></li> <!-- 20210809 수정 -->
                                <li class="msRnb_btn"><a href="/member/member_secession">탈퇴회원관리</a></li>
                                <li class="msRnb_btn"><a href="/member/inquiry">문의관리</a></li>
