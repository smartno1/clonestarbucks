                ...
                <div class="toptittle"><%-- 머리글 --%>
                    ...
                    <div class="body-box"><%--body-box--%>
                        ...
                        <div class="voc_top_bg">
                            ...
                            <a class="btn_ask_list" href="/member/vocList">나의 문의 내역 보기</a>
                        </div>
                        <div class="cheak-box">
                                ...
                                <table >
                                    ...
                                    <tr class="trCellphone">
                                        ...
                                        <td>
                                            <div class="sel_wrap">
                                                ...
                                                <input class="cellphone_input" id="phone2_mask" name="phone2_mask" type="text" maxlength="4" ref="num" value="****" onclick="initPhone2();" onblur="maskingPhone2(this.value);">
                                                <p class="cell_hyphen">-</p>
                                                <input class="cellphone_input" id="phone3" name="phone3" type="text" maxlength="4" ref="num" value="8754" onclick="initPhone3();">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <textarea class="textArea" id="DS_VOC_CN" name="DS_VOC_CN" onpaste="fnPaste(); return false;" oncopy="fnCopy(); return false;" placeholder="관계 법령에 저촉되거나 사회통념 등에 어긋나는 내용(예: 개인정보 보안, 불충분한 증거/귀책 사유에 대한 개인 음해성/음란성 비방, 의도적인 업무 방해 등) 또는 광고성 게시물은 별도의 사전 통보 없이 답변이 되지 않을 수 있으며, 등록된 의견은 처리가 시작되면 수정이 불가하오니 이 점 양지하여 주시기 바랍니다."></textarea>
