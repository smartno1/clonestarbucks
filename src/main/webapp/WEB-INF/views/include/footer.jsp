...
<footer>
    <div class="inner">
        ...
        <div class="fbtn-group">
            <a href="javascript:void(0)" class="fbtn btn--white">찾아오시는 길</a>
            <a href="javascript:void(0)" class="fbtn btn--white">신규입점제의</a>
            <a href="javascript:void(0)" class="fbtn btn--white">사이트 맵</a>
        </div>
