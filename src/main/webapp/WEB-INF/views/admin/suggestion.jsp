                                ...
                                <table>
                                    ...
                                    <c:forEach items="${suggestionList}" var="su">
                                        <tr style="cursor: pointer" onclick="detail(${su.id})">
                                            ...
                                            <td>${su.account}</td>
                                            <td>${su.title}</td>
                                            <td id="checked"  data-checked="${su.checked}" data-replydone="${su.replyDone}"><button class="btt_ck1">답변대기</button></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
...
<div class="foodboot_end">
    ...
    <script type="text/javascript">
        ...
        function confirmCheck(){
            ...
            const suggestionList = document.querySelectorAll('#checked');
            ...
            for(let su of suggestionList){
                ...
                if(su.dataset.checked === "false"){ // 문의내용 확인여부 검사하여 false면 new 표시
