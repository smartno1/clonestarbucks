...
<head>
    ...
    <style>
        ...
        .findListWrap {
            ...
            overflow: hidden;
            position: relative;
            background: url(/images/findWrap_bg.jpg) 50% 0;
        }
        ...
        .findListWrap .findList .section1{
            top: 0;
        }
        .findListWrap .findList .section1 ul{
            top: 700px;
        }
        .findListWrap .findList .section2{
            top: 700px;
        }
        .findListWrap .findList .section2 ul{
            top: 700px;
            width: 812px;
            margin: 0 auto;
        }
        ...
        <div class="findList">
            <div class="findSections">
                <div class="findSection section1">
                    <p class="find_con1">
                        <img src="/images/taste_find_ttl1.png" alt="1. 어떤 풍미에 가장 끌리세요? 가장 좋아하는 음식을 생각해보세요. 그 음식의 어떤 풍미와 재료에 끌리나요?">
                    </p>
                    <ul class="findTaste1" data-tKind="flavor">
                        <li class="ft1_1">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste1_1.png" data-taste="salty" alt="">
                                </a>
                            </div>
                            <p>
                                짭잘한 맛
                        ...
                        <li class="ft1_2">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste1_2.png" data-taste="fruit" alt="">
                                </a>
                            </div>
                            <p>
                                과일 맛
                        ...
                        <li class="ft1_3">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste1_3.png" data-taste="nutty" alt="">
                                </a>
                            </div>
                            <p>
                                고소한 맛
                        ...
                        <li class="ft1_4">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste1_4.png" data-taste="caramel" alt="">
                                </a>
                            </div>
                            <p>
                                달콤한(캐러멜) 맛
                ...
                <div class="findSection section2">
                    <p class="find_con2">
                        <img src="/images/taste_find_ttl2.png" alt="2. 어떤 느낌을 가장 좋아하세요? 느낌이란 커피가 혀와 입천장에 닿았을 때 느껴지는 감각을 의미합니다.">
                    </p>
                    <ul class="findTaste2" data-tkind="feel">
                        <li class="ft2_1">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste2_1.png" data-taste="refresh" alt="">
                                </a>
                            </div>
                            <p>
                                상쾌한 느낌
                        ...
                        <li class="ft2_2">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste2_2.png" data-taste="soft" alt="">
                                </a>
                            </div>
                            <p>
                                부드러운 느낌
                        ...
                        <li class="ft2_3">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste2_3.png" data-taste="longLasting" alt="">
                                </a>
                            </div>
                            <p>
                                오랫동안 여운이 남는 느낌
                ...
                <div class="findSection section3">
                    <p class="find_con3">
                        <img src="/images/taste_find_ttl3.png" alt="3. 어느 정도의 강도를 원하세요? 강도란 커피의 로스트와 풍미의 정도를 말합니다">
                    </p>
                    <ul class="findTaste3" data-tkind="degree">
                        <li class="ft3_1">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste3_1.png" data-taste="gentle" alt="">
                                </a>
                            </div>
                            <p>
                                은은하고 부드러움
                        ...
                        <li class="ft3_2">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste3_2.png" data-taste="medium" alt="">
                                </a>
                            </div>
                            <p>
                                미디업으로 균형 잡힘
                        ...
                        <li class="ft3_3">
                            <div>
                                <a href="javascript:void(0)">
                                    <img src="/images/taste3_3.png" data-taste="strong" alt="">
                                </a>
                            </div>
                            <p>
                                무게감을 주는 강렬함
...
<script>
    ...
    function defaultSlide() {
        ...
        $ul1.style.transition="1.5s ease 0.8s";
        $ul1.style.top = "347px";
    ...
    function slide(){
        document.querySelector('.findList').addEventListener('click', e => {
            ...
            if($tkind.dataset.tkind === 'flavor'){
                ...
                $nexttkind.lastElementChild.style.transition = "1.5s ease 0.8s";
            ...
            if($tkind.dataset.tkind === 'degree'){
                ...
                location.href = "/coffee/findDone?flavor="+taste[0]+"&feel="+taste[1]+"&degree="+taste[2];
