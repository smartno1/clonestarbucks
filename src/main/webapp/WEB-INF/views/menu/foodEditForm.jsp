...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/menu/menuAdd.css">
...
<main class="container-wrapper">
	<form id="form" action="/menu/foodEdit" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
		<div class="container">
			...
			<div class="context-bottom" >
				...
				<a href="/menu/foodDetail?id=${menu.id}"><button id="cancel" class="btn btn-primary submit" type="button">취소</button></a>
			</div>
