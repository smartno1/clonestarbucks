...
import static com.spring.starbucks.member.domain.OAuthValue.KAKAO_APP_KEY;
import static com.spring.starbucks.member.domain.OAuthValue.KAKAO_REDIRECT_URI;
