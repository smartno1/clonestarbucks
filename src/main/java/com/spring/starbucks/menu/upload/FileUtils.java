package com.spring.starbucks.menu.upload;
...
public class FileUtils {
    ...
    public static String uploadFile(MultipartFile file, String uploadPath) {
        ...
        // 풀 경로 - 루트 경로 문자열 생성
        // full-path => D:~resources/static/images/coffee_bean/dfsdjfksfdkjs_상어.jpg
        // res-path =>  /images/coffee_bean/dfsdjfksfdkjs_상어.jpg
